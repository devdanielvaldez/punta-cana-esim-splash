// components/podcasts/SeasonForm.tsx
...
export default function SeasonForm({ initialData, onSubmit, isSubmitting }: SeasonFormProps) {
    ...
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div>
        ...
        <input
          ...
          placeholder="Ej. Temporada 1 o Verano 2023"
        />
        {errors.name && (
      ...
      <div className="flex justify-end">
        ...
        >
          {isSubmitting || isUploading ? 'Guardando...' : initialData ? 'Actualizar Temporada' : 'Crear Temporada'}
        </button>
      </div>
    </form>
  );
